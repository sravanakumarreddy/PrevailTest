...
public class SPC_MultiShippingReg extends BaseTest {
...
@Test(groups="{Regression}",description="125968/288390/288399/288406")
public void TC01_MPCShipping_UI(XmlTest XmlTest) throws Exception
{
...
@Test(groups="{Regression}",description="289842")
	...
	for(int i=0;i<count;i++)
		{
			...
			Thread.sleep(2000);
			//Selected Address
			sa.assertEquals(gVar.assertEqual(MultiShippingPOM.MultiShipping_EditAddressOverlay_SelectedAddress_Dropdown), "Add New Address");
			...
			//first name	
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_FirstName_Label),"Overlay FirstName_Label");
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_FirstName_Textbox),"FirstName Textbox");
			sa.assertEquals(gVar.assertEqual(MultiShippingPOM.MultiShipping_EditAddressOverlay_FirstName_Textbox), "");
			//last name
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_LastName_Label),"Overlay LastName_Label");
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_LastName_Textbox),"LastName Textbox");
			sa.assertEquals(gVar.assertEqual(MultiShippingPOM.MultiShipping_EditAddressOverlay_LastName_Textbox), "");
			//address1
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_Address1_Label),"Overlay Address1_Label");
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_Address1_Textbox),"Address1 Textbox");
			sa.assertEquals(gVar.assertEqual(MultiShippingPOM.MultiShipping_EditAddressOverlay_Address1_Textbox), "");
			//address2
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_Address2_Label),"Overlay Address2_Label");
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_Address2_Textbox),"Address2 Textbox");
			sa.assertEquals(gVar.assertEqual(MultiShippingPOM.MultiShipping_EditAddressOverlay_Address2_Textbox), "");
			//Country
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_Country_Label),"Overlay Country_Label");
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_Country_Textbox),"Country Textbox");
			sa.assertEquals(gVar.assertEqual(MultiShippingPOM.MultiShipping_EditAddressOverlay_Country_Textbox), "United States");
			//State
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_State_Label),"Overlay State_Label");
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_State_Textbox),"State Textbox");
			sa.assertEquals((new Select(l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_State_Textbox))).getFirstSelectedOption(), "Select...");
			//City
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_City_Label),"Overlay City_Label");
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_City_Textbox),"City Textbox");
			sa.assertEquals(gVar.assertEqual(MultiShippingPOM.MultiShipping_EditAddressOverlay_City_Textbox), "");
			//Zip Code
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_Postal_Label),"Overlay Zipcode label");  
			sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_EditAddressOverlay_Postal_Textbox),"Zipcode Textbox");
			sa.assertEquals(gVar.assertEqual(MultiShippingPOM.MultiShipping_EditAddressOverlay_Postal_Textbox), "");
			//Phone
			...
			sa.assertEquals(gVar.assertEqual(MultiShippingPOM.MultiShipping_EditAddressOverlay_Phone_Textbox), "");
...
@Test(groups="{Regression}",description="289674/125961/125959/289534/289669/289572/289675/289677/289681/289577/289679/289684/289683/289666")
public void TC03_MPCShipping_Continue_TO_ShippingMTD_Button_Functionality_And_LineItems_Displayed() throws Exception
{
	int addrCount=0;
	//adding addresses
	for(int i=0;i<2;i++)
	...
	sa.assertTrue(gVar.assertVisible(MultiShippingPOM.Multishipping_RightNav_Shipment1_StaticText),"Shipment No: 1 display");
	sa.assertTrue(gVar.assertVisible(MultiShippingPOM.Multishipping_RightNav_Shipment2_StaticText),"Shipment No: 2 display");
	//Verify the UI
	for(int i=0;i<numOfShipments;i++)
	{
		...
		sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_RightNav_ShippingBlock_Heading, i),"Shipping Address Heading display:"+i);
		sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_RightNav_ShippingBlock_EditLink, i),"Edit Link for Each Address:"+i);
		sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_RightNav_ShippingAddress, i),"Right Nav Shipping Address:"+i);
		sa.assertTrue(gVar.assertVisible(MultiShippingPOM.MultiShipping_RightNav_ShipmentMethod, i),"Right Nav Shipment Method:"+i);
		for(int k=0; k<3;k++)
		{
...
@Test(groups="{Regression}",description="125957/125958")
public void TC04_MPCShipping_ShipmentPage_IsGiftMessage_Functionality() throws Exception
{
...
@Test(groups="{Regression}",description="289817/289819")
public void TC06_EditAddress_Overlay_Hover_APO_FPO_Why_Is_This_Required() throws Exception
{
...
@Test(groups="{Regression}",description="125965")
public void TC07_Add_OR_EditAddressOverlay_Save_Button_Functionality() throws Exception
{
	//click on go strait to checkout link
	log.info("Mouse Hover Mini Cart Link");
	gVar.MouseHover(MiniCartPOM.MiniCartLink);
...
@Test(groups="{Regression}",description="125960")
...
@Test(groups="{Regression}",dataProvider="MPCShippingValidations",dataProviderClass=Data.class, description="289822/289823/289825/289827/289829/289831/289833/289835/289837/289840/289841/125966")
public void TC12_EditAddress_Overlay_Validation(TestData t) throws Exception
{
		...
		Thread.sleep(5000);
		 if(l1.getWebElement(MultiShippingPOM.MultiShipping_EditOverlay_Div).isDisplayed())
			 {
			 	log.info("Clear First Name");
				l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_FirstName_Textbox).clear();
				log.info("Clear Last Name");
				l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_LastName_Textbox).clear();
				log.info("Clear Address1 Name");
				l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_Address1_Textbox).clear();
				log.info("Clear Address2 Name");
				l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_Address2_Textbox).clear();
				log.info("Clear City Name");
				l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_City_Textbox).clear();
				log.info("Clear State Name");
				gVar.handlingDropdown(MultiShippingPOM.MultiShipping_EditAddressOverlay_State_Textbox,"Select...");
				Thread.sleep(3000);
				log.info("Clear ZipCode Name");
				l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_Postal_Textbox).sendKeys(t.get(6));
				Thread.sleep(3000);
				log.info("Clear Phone");
				l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_Phone_Textbox).sendKeys(t.get(7));
				
			 	log.info("Enter shipping address First Name");
				l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_FirstName_Textbox).sendKeys(t.get(0));
				log.info("Enter shipping address Last Name");
				l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_LastName_Textbox).sendKeys(t.get(1));
				log.info("Enter shipping address Address1 Name");
				l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_Address1_Textbox).sendKeys(t.get(2));
				log.info("Enter shipping address Address2 Name");
				l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_Address2_Textbox).sendKeys(t.get(3));
				log.info("Enter shipping address City Name");
				l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_City_Textbox).sendKeys(t.get(4));
				log.info("Enter shipping address State Name");
				...
				Thread.sleep(3000);
				//log.info("Enter shipping address Country Name");
				//gVar.handlingDropdown(MultiShippingPOM.MultiShipping_EditAddressOverlay_Country_Textbox,GetData.getDataFromExcel(Excel,SheetName,Row,7));
				//Thread.sleep(3000);
				log.info("Enter shipping address Phone");
				l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_Phone_Textbox).sendKeys(t.get(7));
				 ...
				 //Max characters
					 ...
					 log.info("Max characters");
		        	 	...
		        	 	log.info("Firstname");
		        		sa.assertEquals(l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_FirstName_Textbox).getText().length(),50);
		        		log.info("Lastname");
		        		sa.assertEquals(l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_LastName_Textbox).getText().length(),50);
		        		log.info("Address1");
		        		sa.assertEquals(l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_Address1_Textbox).getText().length(),50);
		        		log.info("Address2");
		        		sa.assertEquals(l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_Address2_Textbox).getText().length(),50);
		        		log.info("City");
		        		sa.assertEquals(l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_City_Textbox).getText().length(),50);
		        		log.info("Zipcode");
		        		sa.assertEquals(l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_Postal_Textbox).getText().length(),10);
		        		log.info("Phone");
		        		sa.assertEquals(l1.getWebElement(MultiShippingPOM.MultiShipping_EditAddressOverlay_Phone_Textbox).getText().length(),20);    
...
@Test(groups="{Regression}",description="289672")
...
@Test(groups="{Regression}",description="289673/289667/125956")
public void TC14_MultiShipping_2_Individual_Products_SameAddress() throws Exception
{
	log.info("Clear cart");
	cart.ClearCartItems();
	log.info("Navigate to Address Page");
	...
	p.DeleteAddress();
	log.info("Search1");
	s.Search(MultiShippingPOM.Product1);
	s.SelectSwatch();
	log.info("Click on Add to cart button");
	l1.getWebElement("PDP_AddToCart","ShopNav\\PDP.properties").click();
	Thread.sleep(2000);
	log.info("Search2");
	s.Search(MultiShippingPOM.Product2);
	s.SelectSwatch();
	log.info("Click on Add to cart button");
	l1.getWebElement("PDP_AddToCart","ShopNav\\PDP.properties").click();
	Thread.sleep(2000);
	...
	log.info("2 LineItems should be displayed");
	sa.assertEquals(l1.getWebElements(MultiShippingPOM.Shipping_Multiple_CartRow).size(), 2);
	log.info("navigation to Select shipping method");
	l1.getWebElement(MultiShippingPOM.Shipping_Multiple_Address_Save_Button).click();
	Thread.sleep(3000);
	//verify the shipments
	...
	sa.assertEquals(numOfShipments, 2, "No of Shipment methods should be 2 in Shipment page");
	sa.assertEquals(l1.getWebElements(MultiShippingPOM.MultiShipping_OrderSummary_Product_LineItems).size(), 2, "No of Line items should be 2 in Order Summary");
	//Navigating to Address Profile Page
	log.info("Address should be saved in Profile");
	...
	//Address Title
	sa.assertEquals(gVar.assertEqual("Addsress_Default_Title", "Profile\\Addresses.properties"), GetData.getDataFromExcel("\\data\\Checkout.xls","ShippingAddress",1,10));
	//FN LN
	sa.assertEquals(gVar.assertEqual("Addsress_Fname_Lname", "Profile\\Addresses.properties"), GetData.getDataFromExcel("\\data\\Checkout.xls","ShippingAddress",1,11));
	//Mini-address
	sa.assertEquals(gVar.assertEqual("Address_DefaultAddress", "Profile\\Addresses.properties"), GetData.getDataFromExcel("\\data\\Checkout.xls","ShippingAddress",1,12));
	//Delete link
...
@Test(groups="{Regression}",description="289844/15165/15165")
public void TC15_ShippingAddress_PrePopulation_Functionality() throws Exception
{
	log.info("Clear cart");
	cart.ClearCartItems();
	log.info("Navigate to Address Page");
	...
	for (int i = 0; i < 2; i++) {
		sa.assertEquals((new Select(l1.getWebElements("Address_Country", "Profile\\Addresses.properties").get(i))).getFirstSelectedOption().getText(), "Select an Address");
		log.info("Select Addresses from Dropdown");
		gVar.handlingDropdown(MultiShippingPOM.MultiShipping_Address_Dropdown,i, 1);
	}
	l1.getWebElement(MultiShippingPOM.Shipping_Multiple_Address_Save_Button).isEnabled();
	log.info("Click on save Button");
	l1.getWebElement(MultiShippingPOM.Shipping_Multiple_Address_Save_Button).click();
	log.info("Verify the address");
	log.info("Right Nav Shipping Addrress");
	sa.assertEquals(gVar.assertEqual(MultiShippingPOM.MultiShipping_RightNav_ShippingAddress), GetData.getDataFromExcel("\\data\\ProfileData.xls","Address",2,12));
	log.info("Shipment Page Address Block");
	sa.assertEquals(gVar.assertEqual(MultiShippingPOM.MultiShipping_ShipmentPage_Address), GetData.getDataFromExcel("\\data\\ProfileData.xls","Address",2,12));
	log.info("Navigate Back to Shipping Page");
	l1.getWebElement(MultiShippingPOM.MultiShipping_RightNav_ShippingBlock_EditLink).click();
	for (int i = 0; i < 2; i++) {
		log.info("Address verification: "+i);
	sa.assertEquals(gVar.assertEqual(MultiShippingPOM.MultiShipping_Address_Dropdown_SelectedAddress, i), GetData.getDataFromExcel("\\data\\ProfileData.xls","Address",2,13));
	}
	//It will return all the assertions
	sa.assertAll();
}

@Test(groups="{Regression}",description="289687")
public void TC03_MPCShipping_Continue_TO_ShippingMTD_Button_Functionality_And_UI() throws Exception
{
	...
	for(int k=0; k<3;k++)
	{
		log.info("Verification of Shipments Methods display for each Shipments: "+i);
		String ShipmentMtd=driver.findElements(By.xpath("//select[@name='dwfrm_multishipping_shippingOptions_shipments_i"+i+"_shippingMethodID']/option")).get(k).getText();
		sa.assertEquals(ShipmentMtd, GetData.getDataFromExcel("\\data\\Checkout.xls", "ShippingAddress", k+1, 16));		
	}
	log.info("Select Shipping Method for each Shipment");
	gVar.handlingDropdown(MultiShippingPOM.MultiShipping_SelectShippingMethod_Dropdown, i, 1);
	}
	log.info("To check Continue button is enabled");
	l1.getWebElement(MultiShippingPOM.MultiShipping_Continue_To_Billing_Button).isEnabled();
...
@Test(groups="{Regression}",description="")
public void TC16_MultiShipping_ProductImage_Click_Functionality() throws Exception
{
	try {
...
@Test(groups="{Regression}",description="")
public void TC17_MultiShipping_OrderSummary_ProductImage_Name_Click_Functionality() throws Exception
{
	try {
		log.info("click on Product image");
